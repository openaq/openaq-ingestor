...
def test_all_shapes_are_converted(
    ...
    # }, 'Node data does not match'

    # assert client.systems[0] == {
    #     "fetchlogs_id": sample_fetchlog,
    #     'ingest_id': 'testing-station1',
    #     'ingest_sensor_nodes_id': 'testing-station1',
    #     'manufacturer': 'testing',
    #     'model': 'default',
    #     'metadata': '{}' ## json string
    # }, 'System data does not match'

    # assert client.sensors[0] == {
    #     'fetchlogs_id': sample_fetchlog,
    #     'ingest_sensor_systems_id': 'testing-station1',
    #     'ingest_id': 'testing-station1-no',
    #     'measurand': 'no',
    ...
    #     'logging_interval_seconds': 900,
    #     'metadata': '{}',
    # }, 'Sensor data does not match'

    # # measurements are kept as a list of lists
    # assert client.measurements[0] == [
    #     'testing-station1-no',
    #     'testing',  # source_name
    #     'station1', #
    #     'no', # measurand identifier
    #     0.2,
    #     '2024-04-08T21:25:00.000Z',
    #     None, # lon for mobile measurements
    #     None, # lat for mobile measurements
    #     sample_fetchlog,
    # ]
